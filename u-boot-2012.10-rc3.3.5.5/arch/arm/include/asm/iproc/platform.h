...
//
//#include "s2_a/platform_s2_a.h"
#define TINYMT32_RAND_PTR (0xc0010000)
// DEFINE TYPES
...
// It is artifact of sharing code with another platform where there was not enough memory to build both shmoo and "read eye" applications.
...
//
// Those defines are not used in S2_A platform because start address of the DRAM range is dynamic
//
...
//
// Redefine macros from the PHY init code to use functions that will print C-style messages
//
...
//
// This define is not necessary for the S2_A platform because it has other memory controller
//
