...
#if CONFIG_CYGNUS//<chandra:cygnus has 1 CPU

	#include "cygnus.h"
	#define IPROC_NUM_CPUS			(1)

#elif CONFIG_NORTHSTAR
	#define IPROC_NUM_CPUS			(2)
#endif//>chandra:cygnus has 1 CPU
...
#define IPROC__CHIP_ID_REG				(ICFG_CHIP_ID_REG)
#define IPROC_GPIO_REG_BASE				(ChipcommonG_GP_DATA_IN) //(0x18001000)
#define IPROC_PWMCTL					(ChipcommonG_PWMCTL) //(0x18002000)
#define IPROC_MII_Management_Control	(ChipcommonG_MII_Management_Control )//(0x18003000)
#define IPROC_MII_Management_Command_Data	(ChipcommonG_MII_Management_Command_Data)
#define IPROC_MII_Management_Command_Data__SB_R (ChipcommonG_MII_Management_Command_Data__SB_R)
#define IPROC_MII_Management_Command_Data__OP_R (ChipcommonG_MII_Management_Command_Data__OP_R)
#define IPROC_MII_Management_Command_Data__PA_R (ChipcommonG_MII_Management_Command_Data__PA_R)
#define IPROC_MII_Management_Command_Data__RA_R (ChipcommonG_MII_Management_Command_Data__RA_R)
#define IPROC_MII_Management_Command_Data__TA_R (ChipcommonG_MII_Management_Command_Data__TA_R)
#define IPROC_MII_Management_Control__BSY		(ChipcommonG_MII_Management_Control__BSY)
#define IPROC_MII_Management_Control__PRE		(ChipcommonG_MII_Management_Control__BSY)
#define IPROC_MII_Management_Control__EXT		(ChipcommonG_MII_Management_Control__BSY)


#define IPROC_RNG_REG_BASE		(ChipcommonS_RNG_CTRL) //(0x18004000)
#define IPROC_TIM0_REG_BASE		(ChipcommonG_tim0_TIM_TIMER1Load) //(0x18005000)
#define IPROC_TIM1_REG_BASE		(ChipcommonG_tim1_TIM_TIMER1Load) //(0x18006000)
#define IPROC_SRAU_REG_BASE		(0x18007000) //(0x18007000)
#define IPROC_UART0_REG_BASE	(ChipcommonG_UART0_UART_RBR_THR_DLL) //(0x18008000)
...
#define IPROC_GMAC0_REG_BASE		(GMAC0_DEVCONTROL) //(0x18042000)

/* ARM9 Private memory region */
#define IPROC_PERIPH_BASE				(IHOST_SCU_CONTROL) //(IHOST_A9MP_scu_CONTROL)
