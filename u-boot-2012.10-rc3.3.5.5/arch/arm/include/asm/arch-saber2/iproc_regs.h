...
#define IPROC_CCB_SRAU_REG_BASE         (0x18007000)
...
#define IPROC_GMAC0_REG_BASE		(0x18042000) //GMAC0_DEVCONTROL
#define IPROC_GMAC1_REG_BASE		(0x1804a000) //GMAC1_DEVCONTROL
