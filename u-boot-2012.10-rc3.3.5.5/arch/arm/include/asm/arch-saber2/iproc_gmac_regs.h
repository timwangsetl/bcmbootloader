...
typedef volatile struct _gmacregs {
	...
	uint32_t		serdes_ctl;				/* 0x1a8 */
	uint32_t		serdes_status0;			/* 0x1ac */
	uint32_t		serdes_status1;			/* 0x1b0 */
	uint32_t		PAD[11];				/* 0x1b4-1dc */
...
/* SERDESCONTROL fields */
#define	SC_TX1G_FIFO_RST_MASK	0x00f00000 /* 23:20 */
#define	SC_TX1G_FIFO_RST_VAL	0x00f00000
#define	SC_FORCE_SPD_STRAP_MASK	0x00060000 /* 18:17 */
#define	SC_FORCE_SPD_STRAP_VAL	0x00040000 
#define	SC_REF_TERM_SEL_MASK	0x00001000 /* 12 */
#define	SC_REFSEL_MASK			0x00000c00 /* 11:10 */
#define	SC_REFSEL_VAL			0x00000400
#define	SC_REFDIV_MASK			0x00000300  /* 9:8 */
#define	SC_REFDIV_VAL			0x00000000
#define	SC_LCREF_EN_MASK		0x00000040  /* 6 */
#define	SC_RSTB_PLL_MASK		0x00000010  /* 4 */
#define	SC_RSTB_MDIOREGS_MASK	0x00000008  /* 3 */
#define	SC_RSTB_HW_MASK			0x00000004  /* 2 */
#define	SC_IDDQ_MASK			0x00000002  /* 1 */
#define	SC_PWR_DOWN_MASK		0x00000001  /* 0 */
