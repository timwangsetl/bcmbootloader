...
#define IPROC_QSPI_MEM_BASE		(0x1e000000)
#define IPROC_NAND_MEM_BASE		(0x1c000000)
...
#define AMAC_IDM2_IDM_RESET_CONTROL (FA_AMAC_IDM0_IDM_RESET_CONTROL)
#define AMAC_IDM3_IDM_RESET_CONTROL (FA_AMAC_IDM1_IDM_RESET_CONTROL)
