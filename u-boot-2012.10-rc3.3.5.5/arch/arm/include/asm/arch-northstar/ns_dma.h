...
typedef volatile struct _i2sregs {
    ...
    // DMA register
    dma64_t         dma_regs[NUM_DMA_TX]; /* 0x200-0x2fc */

} i2sregs_t;

typedef volatile struct _i2s{
    i2sregs_t *regs;
    dma_info_t *di;
}I2S_Block;
...
bool dma_rxreset(void);
bool dma_txreset(void);
