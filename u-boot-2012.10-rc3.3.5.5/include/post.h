...
#define CONFIG_SYS_POST_SPDIF             0 //0x00004000

#define CONFIG_SYS_POST_RGMII             0x00008000
...
#define CONFIG_SYS_POST_CAM               0x00004000
...
//#define CONFIG_SYS_POST_AMACSWITCH       0x40000000
...
#undef CPU_WRITE_8
#endif
#define CPU_WRITE_8(addr,data) *((volatile uint8_t *)addr) = data
#ifdef CPU_READ_8
#undef CPU_READ_8
#endif
#define CPU_READ_8(addr) *(volatile uint8_t *)addr

#define CPU_RMW_OR_8(addr,data)  (*((volatile uint8_t *)addr) |= data)
#ifdef CPU_WRITE_32
#undef CPU_WRITE_32
#endif
#define CPU_WRITE_32(addr,data) *((volatile uint32_t *)addr) = data
#ifdef CPU_READ_32
#undef CPU_READ_32
#endif
#define CPU_READ_32(addr) *(volatile uint32_t *)addr
