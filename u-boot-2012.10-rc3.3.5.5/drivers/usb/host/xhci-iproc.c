...
//	int retval = 0;
    ...
    printf("\n Configure USB 3.0 PHY \n");
    	...
    	__raw_writel(0x00000001, 0x18104800);
    	__raw_writel(0x00000001, 0x18115800);

        /* Enable MDIO. Setting MDCDIV as 26  */
    	__raw_writel(0x0000009a, 0x18003000);

        /* 2uSec delay for MDC ready */
    	udelay(10);

        /* USB30 PLL block */
        __raw_writel(0x587e8000, 0x18003004);

        /* Setting CML Divider ratio to 26 */
        __raw_writel(0x582a6400, 0x18003004);
        __raw_writel(0x587e80e0, 0x18003004);
        __raw_writel(0x580a009c, 0x18003004);

        /* Enable SSC */
        __raw_writel(0x587e8040, 0x18003004);
        __raw_writel(0x580a21d3, 0x18003004);
        __raw_writel(0x58061003, 0x18003004);

        /* Deaseerting USB3 system soft reset */
        __raw_writel(0x00000000, 0x18104800);
        __raw_writel(0x00000000, 0x18115800);
